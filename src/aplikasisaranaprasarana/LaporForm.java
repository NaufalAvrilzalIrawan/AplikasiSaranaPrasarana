 ...
 * @author N.A.I
 */
public class LaporForm extends javax.swing.JFrame {
     ...
     */
    public LaporForm(int id, String nama, String role) {
        initComponents();
    ...
    */
    ...
    private void tampilkanDataAset() {
        ...
        StringBuilder sqlBuilder = new StringBuilder("SELECT id_aset, nama_aset, kategori FROM aset WHERE kondisi = 'baik'");
    ...
    */
    private void simpanLaporan() {
        ...
        String hariIni = today.format(formatter);
        ...
        String sql = "INSERT INTO kerusakan (`id_user`, `id_aset`, `deskripsi`, `tanggal_lapor`, `status`) VALUES (?, ?, ?, ?, ?)";
        String sql2 = "UPDATE `aset` SET `kondisi`=?, status='tidak tersedia' WHERE id_aset=?";
        ...
        try {
            ...
            pst.setString(4, hariIni);
            pst.setString(5, "terlapor");
            
            pst2.setString(1, "rusak");
            pst2.setInt(2, asetId);
    ...
    private void initComponents() {
        ...
        btnSLapor = new javax.swing.JButton();
        ...
        btnLapor.setBackground(new java.awt.Color(52, 152, 219));
        ...
        btnSLapor.setBackground(new java.awt.Color(102, 0, 204));
        btnSLapor.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnSLapor.setForeground(new java.awt.Color(242, 242, 242));
        btnSLapor.setText("Lapor");
        btnSLapor.setBorder(null);
        btnSLapor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSLaporActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(contentPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(contentPanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(btnSLapor, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(72, 72, 72))))))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(contentPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnSLapor, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(contentPanelLayout.createSequentialGroup()
                                .addGap(22, 22, 22)
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSLaporActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSLaporActionPerformed
        simpanLaporan();
    }//GEN-LAST:event_btnSLaporActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnSLapor;
