 ...
 * @author N.A.I
 */
public class PemeliharaanForm extends javax.swing.JFrame {
     ...
     */
    public PemeliharaanForm(int id, String nama, String role) {
        initComponents();
    ...
    */
    ...
    private void tampilkanDataAset() {
        ...
        StringBuilder sqlBuilder = new StringBuilder("SELECT id_aset, nama_aset, kategori, kondisi, lokasi, hari_pemeliharaan FROM aset");
    ...
    private void todayPemeliharaan() {
        javax.swing.DefaultListModel<String> model = new javax.swing.DefaultListModel<>();
        String today = getHariIni();
        String sql = "SELECT id_aset, nama_aset FROM aset WHERE hari_pemeliharaan = ?";
    ...
    */
    private void isiFormDariTabel() {
        ...
        String kondisi = String.valueOf(model.getValueAt(barisTerpilih, 3));
        String lokasi = String.valueOf(model.getValueAt(barisTerpilih, 4));
        String pelihara = String.valueOf(model.getValueAt(barisTerpilih, 5)); // Ambil sebagai Object untuk handle null
        ...
        if (pelihara != null) {
            txtHari.setText(pelihara); 
        } else {
            txtHari.setText("Tidak ada");
        }
    }
    ...
    */
    ...
    private void setKondisi(String neoKondisi) {
        ...
        String hariPelihara = txtHari.getText();
        String status = "tidak tersedia";
        if (kondisi == "baik") {
            status = "tersedia";
        }
        
        String sql = "UPDATE `aset` SET `kondisi`=?, `status`=? WHERE id_aset=?";
        try {
            Connection conn = ConnectSQL.getKoneksi();
            PreparedStatement pst = conn.prepareStatement(sql);

            pst.setInt(3, id);
            pst.setString(1, neoKondisi);
            pst.setString(2, status);

            System.out.println(pst);
            // Berikan konfirmasi
            int input = JOptionPane.showConfirmDialog(null,"Apakah "+ nama+" dalam keadaan "+ neoKondisi +"?", "Ubah Kondisi", JOptionPane.INFORMATION_MESSAGE);
            if (input == 0){
                int rowsAffected = pst.executeUpdate();

                if (rowsAffected > 0) {
                    JOptionPane.showMessageDialog(this, "Kondisi aset berhasil diubah menjadi "+ neoKondisi +"!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
                    tampilkanDataAset();
                    todayPemeliharaan();
                    kosongkanForm();
                } else {
    ...
    private void initComponents() {
        ...
        btnBaik = new javax.swing.JButton();
        btnRawat = new javax.swing.JButton();
        btnRusak = new javax.swing.JButton();
        ...
        btnPemeliharaan.setBackground(new java.awt.Color(52, 152, 219));
        ...
        lblHeader.setText("MENU PEMELIHARAAN");
        ...
        btnBaik.setBackground(new java.awt.Color(52, 152, 219));
        btnBaik.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnBaik.setForeground(new java.awt.Color(242, 242, 242));
        btnBaik.setText("Baik");
        btnBaik.setBorder(null);
        btnBaik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBaikActionPerformed(evt);
            }
        });

        btnRawat.setBackground(new java.awt.Color(255, 255, 0));
        btnRawat.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnRawat.setForeground(new java.awt.Color(153, 153, 153));
        btnRawat.setText("Perawatan");
        btnRawat.setBorder(null);
        ...
        btnRusak.setBackground(new java.awt.Color(255, 0, 0));
        btnRusak.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnRusak.setForeground(new java.awt.Color(242, 242, 242));
        btnRusak.setText("Rusak");
        btnRusak.setBorder(null);
        btnRusak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRusakActionPerformed(evt);
            }
        });

        todayList.setModel(new javax.swing.AbstractListModel<String>() {
        ...
        jLabel8.setText("Pemeliharaan Hari Ini");
                    ...
                    .addGroup(contentPanelLayout.createSequentialGroup()
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(contentPanelLayout.createSequentialGroup()
                                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(contentPanelLayout.createSequentialGroup()
                                        .addComponent(btnBaik, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(btnRawat, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(btnRusak, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(contentPanelLayout.createSequentialGroup()
                                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(contentPanelLayout.createSequentialGroup()
                                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtKondisi, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(18, 18, 18)
                                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtHari, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(contentPanelLayout.createSequentialGroup()
                ...
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(contentPanelLayout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(btnBaik, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnRawat, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnRusak, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnBaikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBaikActionPerformed
        // Buat perubahan kondisi baik ke database dengan fungsi setKondisi 
        setKondisi("baik");
    }//GEN-LAST:event_btnBaikActionPerformed

    private void btnRusakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRusakActionPerformed
        // Buat perubahan kondisi rusak ke database dengan fungsi setKondisi 
        setKondisi("rusak");
    }//GEN-LAST:event_btnRusakActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PemeliharaanForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnBaik;
    ...
    private javax.swing.JButton btnRusak;
