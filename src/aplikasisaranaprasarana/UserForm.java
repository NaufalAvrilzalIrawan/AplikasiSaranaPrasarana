...
public class UserForm extends javax.swing.JFrame {
     ...
     */
    public UserForm(int id, String nama, String role) {
        initComponents();
    ...
    private void attachFilterListeners() {
        ...
        ActionListener filterListener = e -> tampilkanDataUser();
        
        filterRole.addActionListener(filterListener);
    }
    ...
    */
    ...
    private void tampilkanDataUser() {
        // Kolom untuk tabel
        String[] kolom = {"ID", "Nama", "Username", "Password", "Role"};
        ...
        sqlBuilder.append(" ORDER BY role ASC");
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Gagal mengambil data user: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    */
    private void muatFilterRole() {
        try {
            Connection conn = ConnectSQL.getKoneksi();
            Statement st = conn.createStatement();
            String sql = "SELECT DISTINCT role FROM user ORDER BY role ASC";
            ResultSet rs = st.executeQuery(sql);

            filterRole.removeAllItems(); // Bersihkan item lama
            filterRole.addItem("Semua Role"); // Tambahkan item default
            while (rs.next()) {
                filterRole.addItem(rs.getString("role"));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Gagal memuat filter role: " + e.getMessage());
        }
    }
    ...
    */
    private void isiFormDariTabel() {
        ...
        String nama = String.valueOf(model.getValueAt(barisTerpilih, 1));
        String username = String.valueOf(model.getValueAt(barisTerpilih, 2));
        String password = String.valueOf(model.getValueAt(barisTerpilih, 3));
        String role = String.valueOf(model.getValueAt(barisTerpilih, 4));
    ...
    */
    ...
    private void simpanUser() {
        ...
        if (nama.isEmpty() || username.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nama, Username, dan Password tidak boleh kosong!", "Peringatan", JOptionPane.WARNING_MESSAGE);
        ...
        try {
            ...
            // Berikan konfirmasi
            int input = JOptionPane.showConfirmDialog(null,"Tambahkan " + role +" "+ nama+"?", "Tambah Data", JOptionPane.INFORMATION_MESSAGE);
            if (input == 0){
                // Eksekusi query
    ...
    */
    private void ubahUser() {
        ...
        String sql = "UPDATE user SET nama=?,username=?,password=?,role=? WHERE id_user=?";
        ...
        try {
            ...
            System.out.println(pst);
            // Berikan konfirmasi
            int input = JOptionPane.showConfirmDialog(null,"Apakah data "+ nama+" ingin diubah?", "Ubah Deskripsi", JOptionPane.INFORMATION_MESSAGE);
            if (input == 0){
                int rowsAffected = pst.executeUpdate();
    ...
    */
    ...
    private void initComponents() {
        ...
        btnUser.setBackground(new java.awt.Color(52, 152, 219));
        ...
        filterRole.setBackground(new java.awt.Color(52, 152, 219));
        filterRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        filterRole.setBorder(null);
        ...
        cmbRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "admin", "petugas", "user" }));
                ...
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup()
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(filterRole, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(contentPanelLayout.createSequentialGroup()
                                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
